...
<body id="page-top">
    ...
    <script src="{{ asset('template/temp/js/sb-admin-2.min.js') }}"></script>

    <!-- Page level plugins -->
    <script src="{{ asset('template/temp/vendor/chart.js/Chart.min.js') }}"></script>

    <!-- Page level custom scripts -->
    <script src="{{ asset('template/temp/js/demo/chart-area-demo.js') }}"></script>
    <script src="{{ asset('template/temp/js/demo/chart-pie-demo.js') }}"></script>
